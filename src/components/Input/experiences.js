...
const Experiences = () => {
    return (
      [{
        ...
        "content":"<h5>Led strategy team at a leading Pharma Co. focused on improving patient compliance by enabling at-home alternatives to traditional point of care services. Worked with medical affairs, legal/regulatory, and the digital transformation CoE to research market dynamics, technology trends, and patient/provider challenges, culminating in a north star vision for digital health at their organization.<br /><br />Alongside the overarching strategy, the initiative resulted in partnership with a startup pursuing early trials of a microfluidics device for early detection of poor kidney function.</h5><br /><p># BACKGROUND:<br />  The diabetes epidemic incurs heavy costs in the health system. End-stage kidney failure (ESRD) is among the most expensive complications of diabetes, but chronic kidney disease (CKD) is difficult to diagnose. Kidney damage often goes unchecked until major complications arise.<br /><br />Metformin, the leading 1st line therapy for diabetes, also has negative side effects on kidney function. <b>We hypothesized that at-home diagnostics or genetic tests for CKD risk would expand early diagnoses and result in increased conversion from Metformin to insulin or GLP-1s.<br /><br />The initiative resulted in partnership with a startup pursuing early trials of a novel microfluidics device for early detection of poor kidney function.</b> My client holds a strong market share of existing Metformin alternatives, so we expect a large portion of the increased sales to be captured directly with knock-on effects for pricing power due to improved long-term outcomes.</p>"
       },{
        "id":2,
        "name":"foundation",
